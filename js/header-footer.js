document.addEventListener('DOMContentLoaded', () => {
    ...
    const customizeHeaderLinks = () => {
        ...
        if (pathname.includes('/admin.html')) {
            ...
            // Overwrite links for admin page
    ...
    // Load header first, then customize it, then load footer.
